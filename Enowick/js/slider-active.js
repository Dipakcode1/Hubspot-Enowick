(function ($) {
	...
	var si_marquee_slide = new Swiper(".ew-marquee-active", {
		loop: true,
		freemode: true,
		slidesPerView: 'auto',
		spaceBetween: 165,
	...
	var swiper = new Swiper(".ew-project", {
		slidesPerView: 1,
		spaceBetween: 30,
		loop: true,
		navigation: {
		prevEl: ".ew-button-prev",
		nextEl: ".ew-button-next",
		},
		breakpoints: {
		1920: {
			slidesPerView: 2,
	...
	// Step 1: Thumb Swiper
	var thumbSwiper = new Swiper(".ew-testimonial-bottom-thumb-active", {
		direction: 'vertical',
		spaceBetween: 30,
		centeredSlides: true,
		slidesPerView: 3,
	...
	var mainSwiper = new Swiper(".ew-testimonial-content-active", {
		spaceBetween: 24,
		slidesPerView: 1,
		loop: true,
		loopedSlides: 4,
	...
	var authorSwiper = new Swiper(".ew-testimonial-bottom-author-active", {
		spaceBetween: 24,
		slidesPerView: 1,
		loop: true,
		loopedSlides: 4,
		...
		var nextBtn = document.querySelector(".ew-testimonial-next");
		if (nextBtn) {
